...
function downloadResume() {
  // URL to your resume file (change this to your actual file path)
  const resumeUrl = 'assets/LensonLim_resume.pdf';

  // Create an anchor element to trigger the download
  const link = document.createElement('a');
  link.href = resumeUrl;
  link.download = 'LensonLim_resume.pdf'; // Change the filename as needed
